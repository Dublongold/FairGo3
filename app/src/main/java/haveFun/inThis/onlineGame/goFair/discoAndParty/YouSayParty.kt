...
import haveFun.inThis.onlineGame.goFair.tools.youSayParty.PartyBooleanSetter
import haveFun.inThis.onlineGame.goFair.tools.youSayParty.PartyIntegerSetter
import haveFun.inThis.onlineGame.goFair.tools.youSayParty.PartyWebClientAndWebChromeClient
import haveFun.inThis.onlineGame.goFair.tools.youSayParty.WorkerWithFileForParty
import haveFun.inThis.onlineGame.goFair.tools.youSayParty.WorkerWithIntents
...
class YouSayParty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initialUrl = Firebase.remoteConfig.getString("url")
